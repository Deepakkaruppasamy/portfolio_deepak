            ...
            <AnimatePresence>
                {selectedCertificate && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-background/95 backdrop-blur-3xl z-[100] flex items-center justify-center p-6 md:p-12"
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-6xl rounded-[3rem] overflow-hidden shadow-[0_0_100px_rgba(var(--primary),0.2)] bg-card border border-border/50 aspect-video"
                        >
                            <motion.button
                                whileHover={{ scale: 1.1, rotate: 90 }}
                                whileTap={{ scale: 0.9 }}
                                onClick={() => setSelectedCertificate(null)}
                                className="absolute top-8 right-8 p-4 bg-background/50 hover:bg-foreground hover:text-background rounded-full transition-all z-20 shadow-xl backdrop-blur-md"
                            >
                                <X size={28} />
                            </motion.button>
